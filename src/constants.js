...
// New UI Constants for Random Pack Features
const FILL_RANDOM_BTN_ID = 'pfp-fill-random-btn';
const CLICK_PAGE_RANDOM_BTN_ID = 'pfp-click-page-random-btn';
const CLICK_PAGE_RANDOM_COUNT_ID = 'pfp-click-page-random-count'; // Input for click count
...
const DEFAULT_CONFIG = {
    version: 24,        // Incremented config version for Random Pack features
    lastMode: 'fixed',
    lastCount: 10,
    lastFixedQty: 1,
    lastMinQty: 1,
    ...
    // New Random Pack Options
    clickPageRandomCount: 1, // Default number of times to click page random button
};
